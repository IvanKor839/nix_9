...
import static ua.com.alevel.utill.WebRequestUtill.DEFAULT_ORDER_PARAM_VALUE;
...
public abstract class AbstractController {
    ...
    protected <RES extends ResponseDto> List<HeaderData> getHeaderDataList(HeaderName[] columnNames, PageData<RES> response) {
