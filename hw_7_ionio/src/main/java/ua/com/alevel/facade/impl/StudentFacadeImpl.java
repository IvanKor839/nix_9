...
public class StudentFacadeImpl implements StudentFacade {
    ...
    public void create(StudentRequestDto studentRequestDto) {
        ...
        student.setIdGroup(studentRequestDto.getIdGroup());
    ...
    @Override
    public Collection<StudentResponseDto> findAllStudentInGroup(String idGroup) throws IOException {
        return studentService.findAllStudentInGroup(idGroup).stream().map(StudentResponseDto::new).collect(Collectors.toCollection(LinkedHashSet::new));
    }
}
